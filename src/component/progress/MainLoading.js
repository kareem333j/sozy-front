...
const MainLoading = () => {
    ...
    useEffect(() => {
        ...
        return () => clearInterval(interval); // تنظيف التايمر عند إلغاء المكون
    }, []);

    return (
        <div className='position-fixed w-100 d-flex flex-column gap-3 justify-content-center align-items-center' style={{ top: '0', backgroundColor: "#121212", left: '0', height: '100vh', zIndex: '9999' }}>
            <svg
                id="svg-global"
            ...
            <h3 dir='rtl' style={{color:'#fff'}}>جاري التحميل{dots}</h3>
        </div>
    )
}
